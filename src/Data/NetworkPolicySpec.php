...
use Dealroadshow\K8S\Data\Collection\NetworkPolicyEgressRuleList;
use Dealroadshow\K8S\Data\Collection\NetworkPolicyIngressRuleList;
 ...
 */
class NetworkPolicySpec implements JsonSerializable
{
    /**
     ...
     */
    private NetworkPolicyEgressRuleList $egress;
     ...
     */
    private NetworkPolicyIngressRuleList $ingress;
     ...
     */
    private StringList $policyTypes;

    public function __construct()
    {
        $this->egress = new NetworkPolicyEgressRuleList();
        $this->ingress = new NetworkPolicyIngressRuleList();
        $this->podSelector = new LabelSelector();
        $this->policyTypes = new StringList();
    }

    public function egress(): NetworkPolicyEgressRuleList
    {
        return $this->egress;
    }

    public function ingress(): NetworkPolicyIngressRuleList
    {
        return $this->ingress;
    }
    ...
    public function policyTypes(): StringList
    {
