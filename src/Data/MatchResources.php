...
use Dealroadshow\K8S\Data\Collection\NamedRuleWithOperationsList;
 ...
 */
class MatchResources implements JsonSerializable
{
    /**
     ...
     */
    private NamedRuleWithOperationsList $excludeResourceRules;
     ...
     * matches _any_ Rule.
     */
    private NamedRuleWithOperationsList $resourceRules;

    public function __construct()
    {
        $this->excludeResourceRules = new NamedRuleWithOperationsList();
        $this->namespaceSelector = new LabelSelector();
        $this->objectSelector = new LabelSelector();
        $this->resourceRules = new NamedRuleWithOperationsList();
    }

    public function excludeResourceRules(): NamedRuleWithOperationsList
    {
    ...
    public function resourceRules(): NamedRuleWithOperationsList
    {
