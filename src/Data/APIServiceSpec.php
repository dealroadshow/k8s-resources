 ...
 * verification.
 */
class APIServiceSpec implements JsonSerializable
{
    /**
    ...
    public function setGroupPriorityMinimum(int $groupPriorityMinimum): self
    {
        $this->groupPriorityMinimum = $groupPriorityMinimum;
    ...
    public function setInsecureSkipTLSVerify(bool $insecureSkipTLSVerify): self
    {
    ...
    public function setVersionPriority(int $versionPriority): self
    {
        $this->versionPriority = $versionPriority;
