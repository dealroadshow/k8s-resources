...
class LimitedPriorityLevelConfiguration implements JsonSerializable
{
     ...
     * infinite.
     */
    private int|null $borrowingLimitPercent = null;
     ...
     */
    private int|null $lendablePercent = null;
     ...
     */
    private int|null $nominalConcurrencyShares = null;
    ...
    public function setBorrowingLimitPercent(int $borrowingLimitPercent): self
    {
    ...
    public function setLendablePercent(int $lendablePercent): self
    {
    ...
    public function setNominalConcurrencyShares(int $nominalConcurrencyShares): self
    {
